...
<h2 class="mt-2 nadpisy">Absolvované</h2>
        ...
        <div class="col-12 offset-sm-6 offset-md-4 offset-lg-3 col-lg-8">
            <div class="container mt-5">
                <div class="row justify-content-center">
                    @foreach($absolvovane as $absolvovana)

                        <div class="col-12 col-lg-4 mb-4">
                            <div class="karticka oblubeneKarticky">

                                <p class="mt-2 kartickaNadpisy">{{$absolvovana->nazov_vrchola}}</p>
                                <img src="{{asset('Obrazky/Vrcholy/'.$absolvovana->obrazok)}}" class="img-fluid" alt="Popis">
                                <p class="mt-2">Názov vrcholu: {{ $absolvovana->nazov_vrcholu}}</p>
                                <p class="mt-2">Štát: {{ $absolvovana->stat}}</p>
                                <p class="mt-2">Okres: {{ $absolvovana->okres}}</p>
                                <p class="mt-2">Nadmorská výška: {{ $absolvovana->nadmorska_vyska}}</p>
                                <p class="mt-2">Pohorie: {{ $absolvovana->pohorie}}</p>
